...
PY
  ...
  RUNTIME_ENV_VARS="GOOGLE_CLOUD_PROJECT=${PROJECT},FIREBASE_STORAGE_BUCKET=${BUCKET},V2_AUTH_ENABLED=true,V1_LEGACY_ENABLED=false,V1_LEGACY_ALLOW_UNLOCK=false,V2_ALLOW_MEDIUM_UNLOCK=false,V2_ADAPTIVE_LEARNING=false,ADMIN_TLS_PAYLOAD_ENABLED=true,ADMIN_TLS_REQUIRE_HTTPS=true,MAX_REQUEST_BYTES=${MAX_REQUEST_BYTES},MAX_IMAGE_BYTES=${MAX_IMAGE_BYTES},MAX_IMAGE_PIXELS=${MAX_IMAGE_PIXELS},MODEL_MANIFEST_PATH=${MODEL_MANIFEST_PATH},MODEL_MANIFEST_URI=${MODEL_MANIFEST_URI},MODEL_MANIFEST_VERSION=${MODEL_MANIFEST_VERSION},MODEL_MANIFEST_SHA256=${MODEL_MANIFEST_SHA256}"
}
